...
public class SeedingCell extends RelativeLayout {
    ...
    public SeedingCell(Context context, Integer teamNumber) {
        ...
        if (teamNumber != null) {
            ...
            String predictedRankingPoints = (Utils.fieldIsNotNull(teamTeam, "calculatedData.predictedRPs") ? Utils.roundDataPoint(Utils.getObjectField(teamTeam, "calculatedData.predictedRPs"), 2, "?") : "?");
