...
public class LastFourMatchesSectionAdapter extends TeamSectionAdapter {
    ...
    static String[] rankInsteadOfGraph = {
            ...
            "calculatedData.lfmAvgCargoScored", "calculatedData.lfmAvgPanelsScored", "calculatedData.lfmAvgCargoFouls", "calculatedData.lfmPanelLoadSuccess",
            "calculatedData.lfmCargoCycleAll", "calculatedData.lfmPanelCycleAll", "calculatedData.lfmCargoSuccessDefended", "calculatedData.lfmCargoSuccessL2",
            "calculatedData.lfmCargoSuccessL3", "calculatedData.lfmPanelSuccessDefended", "calculatedData.lfmPanelSuccessL2", "calculatedData.lfmPanelSuccessL3",
    ...
    static String[][] fieldsToDisplay = {
            ...
            {"calculatedData.lfmHabLineSuccessL1", "calculatedData.lfmHabLineSuccessL2",},
            {"calculatedData.lfmAvgCargoScored", "calculatedData.lfmAvgPanelsScored", "calculatedData.lfmAvgCargoFouls", "calculatedData.lfmPanelLoadSuccess", "calculatedData.lfmCargoCycleAll", "calculatedData.lfmPanelCycleAll", "calculatedData.lfmCargoSuccessDefended", "calculatedData.lfmCargoSuccessL2", "calculatedData.lfmCargoSuccessL3", "calculatedData.lfmPanelSuccessDefended", "calculatedData.lfmPanelSuccessL2", "calculatedData.lfmPanelSuccessL3"},
            {"calculatedData.lfmAvgTimeClimbing"},
            {"calculatedData.lfmPercentIncap", "calculatedData.lfmAvgTimeIncap", "calculatedData.lfmPercentNoShow",}
    };
